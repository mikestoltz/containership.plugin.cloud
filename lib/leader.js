...
module.exports = {
    ...
    initialize: function(core, config) {
        const firewall = new Firewall(core);
        firewall.enable();
        ...
        function register_cluster(callback) {
            ...
            const options = {
                ...
                json: {
                    ...
                    containership_version: core.options && core.options.metadata && core.options.metadata.containership && core.options.metadata.containership.version,
    ...
    setup: (core, config) => {
        ...
        if(cache.snapshotting_configuration && cache.snapshotting_configuration.schedule) {
            const snapshot_options = {
                ...
                persist_data: cache.snapshotting_configuration && cache.snapshotting_configuration.persist_data
            };
